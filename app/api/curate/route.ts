...
2. reason 첫 문장은 그 책과 "${topic}" 주제의 접점을 서술할 것. 책이 여러
   소재를 다루면 "${topic}"와 관련된 소재를 우선 언급할 것.
3. 각 책이 배정된 관점 라벨과 모순되는 관점 서술을 쓰지 말 것. 예를 들어
   "${labelB}" 관점에 배정된 책의 reason에 "${labelA}" 쪽을 시사하는 표현을
   쓰면 안 되고, 그 반대도 마찬가지야. 단, 태그·책소개에서 관점의 근거가
