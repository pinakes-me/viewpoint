...
const QUEUE = [
  ...
  {
    titlePattern: "노숙 인생",
    newTopics: "#자연과공존 #자연과인간 #여행 #소설",
    note: "제목 오독 기반 태그 세트 전면 교체, 2026-07-13 책소개 대조 판정",
  },
  {
    titlePattern: "젊음의 나라",
    newTopics:
      "#청년문제 #세대갈등 #미래사회 #노인복지 #공동체 #소설 #기술과인간",
    note: "AI 접점 참 태그 보강, 2026-07-13 책소개 대조 판정 — #미래사회는 참 태그이므로 유지, R4로 유의어에서만 제거됨",
  },
  {
    titlePattern: "영원을 향하여",
    newTopics:
      "#불멸 #영원 #과학과윤리 #기억과정체성 #근미래사회 #소설 #기술과인간",
    note: "R4 여파로 무소속화 — AI·기계의식이 중심 서사인 SF로 판정, 참 태그 보강 잔류. 2026-07-13 Hailey 판정. 구 소속 근거였던 '미래사회'⊂'근미래사회' 부분 문자열 적중은 유형② 사례",
  },
];
// ──────────────────────────────────────────────────────────────────────────
